---
canonical_term: ruleset-promotion
canonical_slug: ruleset-promotion
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: ruleset-promotion
  en:
    status: verified_source
    spelling: ruleset-promotion
alternative_spellings:
- ruleset-promotion
short_definition: Promosi ruleset=dapat terjadi hanya setelah SIGNOFF. Saat ini gagal-tertutup
  (fail-closed).
...
- path: phase-1/conformance/STATUS.json
  role: policy
  quote: can_promote_ruleset_using
