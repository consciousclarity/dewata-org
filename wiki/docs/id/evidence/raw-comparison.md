---
canonical_term: raw-comparison
canonical_slug: raw-comparison
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: raw-comparison
  en:
    status: verified_source
    spelling: raw-comparison
alternative_spellings:
- raw-comparison
short_definition: Perbandingan dua implementasi pada keluaran rentang tanggal tanpa
  normalisasi.
