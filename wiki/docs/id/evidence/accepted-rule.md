---
canonical_term: accepted-rule
canonical_slug: accepted-rule
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: accepted-rule
  en:
    status: verified_source
    spelling: accepted-rule
alternative_spellings:
- accepted-rule
short_definition: Status yang menandakan aturan diterima oleh customary authority.
  Belum ada satupun yang tercatat di v0.1.
...
related_terms: []
source_citations:
- path: phase-1/docs/runbook/SIGNOFF.md
  role: policy
  quote: (none recorded for v0.1)
