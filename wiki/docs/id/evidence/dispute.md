---
canonical_term: dispute
canonical_slug: dispute
category: evidence
language_variants:
  ban:
...
- dispute
short_definition: Catatan terbuka di disputes.json dengan lima field wajib per PROTOCOL
  §3.3.
...
- path: docs/PROTOCOL.md
  role: policy
  quote: §3 dispute classes
- path: docs/runbook/DISPUTE_REVIEW_PROTOCOL.md
  role: policy
