---
canonical_term: provenance
canonical_slug: provenance
category: evidence
language_variants:
  ban:
...
- provenance
short_definition: Catatan asal sebuah artefak (path repo, hash, tanggal akses, dll).
...
related_terms: []
source_citations:
- path: phase-1/docs/PROTOCOL.md
  role: policy
  quote: §2.1 / §2.4
- path: phase-1/evidence/README.md
  role: policy
