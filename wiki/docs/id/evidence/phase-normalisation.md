---
canonical_term: phase-normalisation
canonical_slug: phase-normalisation
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: phase-normalisation
  en:
    status: verified_source
    spelling: phase-normalisation
alternative_spellings:
- phase-normalisation
short_definition: Proses pengurangan offset fase konstan untuk membandingkan implementasi
  yang berbeda epoch.
