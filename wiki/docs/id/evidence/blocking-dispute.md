---
canonical_term: blocking-dispute
canonical_slug: blocking-dispute
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: blocking-dispute
  en:
    status: verified_source
    spelling: blocking-dispute
alternative_spellings:
- blocking-dispute
short_definition: Dispute yang tingkatannya 'blocking' (lihat PROTOCOL §3.4).
