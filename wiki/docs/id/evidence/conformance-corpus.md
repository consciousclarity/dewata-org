---
canonical_term: conformance-corpus
canonical_slug: conformance-corpus
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: conformance-corpus
  en:
    status: verified_source
    spelling: conformance-corpus
alternative_spellings:
- conformance-corpus
short_definition: Corpus yang disimpan di `phase-1/conformance/published/` (lihat
  STATUS.json schema).
