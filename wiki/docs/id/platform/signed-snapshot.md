---
canonical_term: signed-snapshot
canonical_slug: signed-snapshot
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: signed-snapshot
  en:
    status: verified_source
    spelling: signed-snapshot
alternative_spellings:
- signed-snapshot
short_definition: Snapshot isi repo yang ditandatangani dengan kunci AGE.
...
related_terms: []
source_citations:
- path: phase-1/src/dewatacalendar/runbook.py
  role: implementation
