---
canonical_term: release-manifest
canonical_slug: release-manifest
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: release-manifest
  en:
    status: verified_source
    spelling: release-manifest
alternative_spellings:
- release-manifest
short_definition: MANIFEST.txt yang mendaftar path + sha256 untuk sebuah rilis.
