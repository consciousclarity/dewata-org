---
canonical_term: ruleset-version
canonical_slug: ruleset-version
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: ruleset-version
  en:
    status: implementation_definition
    spelling: ruleset-version
alternative_spellings:
- ruleset-version
short_definition: String `pawukon-v0.4.1+saka-bali-v0.2.3+wewaran-v0.3.0+rahinan-v0.2.0`
  (saat ini).
