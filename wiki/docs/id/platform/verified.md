---
canonical_term: verified
canonical_slug: verified
category: platform
language_variants:
  ban:
...
- verified
short_definition: Tingkat visibilitas untuk record yang sudah diverifikasi oleh sumber
  terpisah.
