---
canonical_term: banjar-visibility
canonical_slug: banjar-visibility
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: banjar-visibility
  en:
    status: implementation_definition
    spelling: banjar-visibility
alternative_spellings:
- banjar-visibility
short_definition: Tier visibilitas yang menampilkan record ke banjar terkait saja.
