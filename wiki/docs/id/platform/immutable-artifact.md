---
canonical_term: immutable-artifact
canonical_slug: immutable-artifact
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: immutable-artifact
  en:
    status: verified_source
    spelling: immutable-artifact
alternative_spellings:
- immutable-artifact
short_definition: Artefak yang tidak boleh dimodifikasi; lihat RULESET_VERSIONING.md
  inv-5.
