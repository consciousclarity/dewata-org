---
canonical_term: checksum-sha256
canonical_slug: checksum-sha256
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: checksum-sha256
  en:
    status: verified_source
    spelling: checksum-sha256
alternative_spellings:
- checksum-sha256
short_definition: Hash SHA-256 yang dipakai untuk verifikasi integritas artefak.
...
related_terms: []
source_citations:
- path: phase-1/evidence/cross-validation/1900-2099/SHA256SUMS
  role: evidence
- path: phase-1/evidence/references/balinese-wariga-sources/edysantosa-sakacalendar/LICENSE.LGPL-2.1
  role: evidence
