...
- epoch-anchor
short_definition: Tanggal yang dideklarasikan sebagai cycle anchor untuk engine (di
  mana position_in_cycle == 1).
...
Tanggal yang dideklarasikan sebagai cycle anchor untuk engine (di mana position_in_cycle == 1).
