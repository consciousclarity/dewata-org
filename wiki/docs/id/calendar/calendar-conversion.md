...
- calendar-conversion
short_definition: Fungsi compose_day(date) di API engine menggabungkan semua layer
  menjadi satu CalendarDay JSON.
...
Fungsi compose_day(date) di API engine menggabungkan semua layer menjadi satu CalendarDay JSON.
