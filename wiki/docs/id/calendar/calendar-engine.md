...
- calendar-engine
short_definition: 'Lapisan engine: pawukon → saka → wewaran → rahinan → compose_day.
  Setiap layer adalah modular dan tidak boleh merujuk layer di atasnya.'
...
Lapisan engine: pawukon → saka → wewaran → rahinan → compose_day. Setiap layer adalah modular dan tidak boleh merujuk layer di atasnya.
