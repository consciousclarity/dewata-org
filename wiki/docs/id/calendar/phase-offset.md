---
canonical_term: phase-offset
canonical_slug: phase-offset
category: calendar
language_variants:
  ban:
  ...
  id:
    ...
    spelling: phase-offset
  en:
    status: implementation_definition
    spelling: phase-offset
alternative_spellings:
- phase-offset
short_definition: Konstanta offset fase antara engine dan sumber referensional, diukur
  terhadap Peradnya dan Rust adapter. Disengaja didokumentasikan di STATUS.json.
...
related_terms: []
source_citations:
- path: phase-1/docs/audit/CROSS_VALIDATION_full_range_1900_2099_2026-09-16.md
  role: evidence
  quote: constant_offsets (Pancawara -1 mod 5, Pawukon +84 mod 210, Wuku +12 mod 30)
- path: phase-1/docs/audit/two-axis-analysis.md
  role: audit-record
...
Konstanta offset fase antara engine dan sumber referensional, diukur terhadap Peradnya dan Rust adapter. Disengaja didokumentasikan di STATUS.json.
