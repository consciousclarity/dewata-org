...
- nampih-sasih
short_definition: 'Interkalasi Saka Bali: mencegah Tilem Kapitu jatuh di Desember
  Gregorian.'
...
- path: phase-1/src/dewatacalendar/rulesets.py
  role: ruleset
  quote: nampih_threshold_months=(12,11)
...
Interkalasi Saka Bali: mencegah Tilem Kapitu jatuh di Desember Gregorian.
