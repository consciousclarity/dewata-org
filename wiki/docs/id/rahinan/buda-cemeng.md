---
canonical_term: buda-cemeng
canonical_slug: buda-cemeng
category: rahinan
language_variants:
  ban:
  ...
  id:
    ...
    spelling: buda-cemeng
  en:
    status: implementation_definition
    spelling: buda-cemeng
alternative_spellings:
- buda-cemeng
short_definition: Rabu Wage; 'Buda Cemeng' (Pancawara Wage); engine tidak mengeluarkannya
...
Rabu Wage; 'Buda Cemeng' (Pancawara Wage); engine tidak mengeluarkannya
