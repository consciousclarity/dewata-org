...
saat ini mengimplementasikan **9 id rahinan** (lihat indeks di
...
Tiga id berikut dari versi-versi sebelumnya tidak lagi dipancarkan
dan didokumentasikan sebagai permukaan yang belum diimplementasikan:

- [Purnama](/id/rahinan/purnama.md) — bulan purnama (belum diimplementasikan)
- [Tilem](/id/rahinan/tilem.md) — bulan mati (belum diimplementasikan)
- [Nyepi](/id/rahinan/nyepi.md) — Hari Raya Nyepi (predikat tidak pernah terpicu; lihat halaman)
...
| [Purnama](/id/rahinan/purnama.md) | bulan purnama | implementation_definition (belum diimplementasikan) |
| [Tilem](/id/rahinan/tilem.md) | bulan mati | implementation_definition (belum diimplementasikan) |
...
pemetaan 9 id engine yang saat ini dipancarkan ke nama hari.
