---
canonical_term: buda-kliwon
canonical_slug: buda-kliwon
category: rahinan
language_variants:
  ban:
  ...
  id:
    ...
    spelling: buda-kliwon
  en:
    status: implementation_definition
    spelling: buda-kliwon
alternative_spellings:
- buda-kliwon
short_definition: Rabu (Buda) + Keliwon (Pancawara); 'hari keramat'
...
Rabu (Buda) + Keliwon (Pancawara); 'hari keramat'
