---
canonical_term: anggara-kasih
canonical_slug: anggara-kasih
category: rahinan
language_variants:
  ban:
  ...
  id:
    ...
    spelling: anggara-kasih
  en:
    status: implementation_definition
    spelling: anggara-kasih
alternative_spellings:
- anggara-kasih
short_definition: Selasa (Anggara) + Keliwon (Pancawara); 'hari kasih sayang'
...
Selasa (Anggara) + Keliwon (Pancawara); 'hari kasih sayang'
