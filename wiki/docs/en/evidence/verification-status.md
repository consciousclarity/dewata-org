---
canonical_term: verification-status
canonical_slug: verification-status
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: verification-status
  en:
    status: verified_source
    spelling: verification-status
alternative_spellings:
- verification-status
short_definition: 'first orthogonal axis of STATUS.json: UNVERIFIED | VERIFIED.'
