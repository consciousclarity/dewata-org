---
canonical_term: implementation-observation
canonical_slug: implementation-observation
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: implementation-observation
  en:
    status: verified_source
    spelling: implementation-observation
alternative_spellings:
- implementation-observation
short_definition: what the engine can be observed to produce for a given date.
