---
canonical_term: normalised-comparison
canonical_slug: normalised-comparison
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: normalised-comparison
  en:
    status: verified_source
    spelling: normalised-comparison
alternative_spellings:
- normalised-comparison
short_definition: comparison after phase normalisation, checking cycle shape without
  offsets.
