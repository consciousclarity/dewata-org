---
canonical_term: reference-eligibility
canonical_slug: reference-eligibility
category: evidence
language_variants:
  ban:
  ...
  id:
    ...
    spelling: reference-eligibility
  en:
    status: verified_source
    spelling: reference-eligibility
alternative_spellings:
- reference-eligibility
short_definition: 'second orthogonal axis of STATUS.json: INELIGIBLE | ELIGIBLE.'
