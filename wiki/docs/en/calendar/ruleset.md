---
canonical_term: ruleset
canonical_slug: ruleset
category: calendar
language_variants:
  ban:
...
- ruleset
short_definition: 'Current ruleset version: pawukon-v0.4.1+saka-bali-v0.2.3+wewaran-v0.3.0+rahinan-v0.2.0.
  Promotion requires customary sign-off (see SIGNOFF.md).'
...
- path: phase-1/conformance/STATUS.json
  role: policy
- path: phase-1/docs/runbook/RULESET_VERSIONING.md
  role: policy
...
Current ruleset version: pawukon-v0.4.1+saka-bali-v0.2.3+wewaran-v0.3.0+rahinan-v0.2.0. Promotion requires customary sign-off (see SIGNOFF.md).
