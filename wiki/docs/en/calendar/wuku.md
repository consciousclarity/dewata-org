...
- wuku
short_definition: The list of 30 wuku (7-day cycles) the engine uses; Balinese spellings
  are listed in WUKU_I18N.
...
- path: phase-1/src/dewatacalendar/i18n.py
  role: implementation
  quote: WUKU_I18N (30 wuku)
- path: phase-1/src/dewatacalendar/pawukon.py
  role: implementation
  quote: WUKU_NAMES_BALINESE (used by compose_day)
...
The list of 30 wuku (7-day cycles) the engine uses; Balinese spellings are listed in WUKU_I18N.
