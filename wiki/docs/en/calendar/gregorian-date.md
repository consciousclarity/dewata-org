...
- gregorian-date
short_definition: Gregorian dates are accepted by the engine for years 1..9999 (pawukon)
  and ≥1979 (saka).
...
Gregorian dates are accepted by the engine for years 1..9999 (pawukon) and ≥1979 (saka).
