---
canonical_term: sasih
canonical_slug: sasih
category: calendar
language_variants:
  ban:
...
- sasih
short_definition: 12 lunar months. sasih_idx ∈ [1..12]. Engine name-to-index mapping
  vs KB Org attestation is disputed (see disputes.json).
...
- path: phase-1/src/dewatacalendar/i18n.py
  role: implementation
  quote: SASIH_I18N (12 sasih with sasih_idx 1..12)
- path: phase-1/docs/runbook/disputes.json
  role: policy
  quote: DISPUTE-ENGINE-SASIH-INDEX-INVERSION
...
12 lunar months. sasih_idx ∈ [1..12]. Engine name-to-index mapping vs KB Org attestation is disputed (see disputes.json).
