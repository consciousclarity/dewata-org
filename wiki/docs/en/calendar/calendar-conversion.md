---
canonical_term: calendar-conversion
canonical_slug: calendar-conversion
category: calendar
language_variants:
  ban:
  ...
  id:
    ...
    spelling: calendar-conversion
  en:
    status: implementation_definition
    spelling: calendar-conversion
alternative_spellings:
- calendar-conversion
short_definition: compose_day(date) in the engine's API combines all layers into a
  single CalendarDay JSON object.
...
compose_day(date) in the engine's API combines all layers into a single CalendarDay JSON object.
