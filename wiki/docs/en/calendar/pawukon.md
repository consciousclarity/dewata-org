---
canonical_term: pawukon
canonical_slug: pawukon
category: calendar
language_variants:
  ban:
...
- pawukon
short_definition: The 210-day cycle partitioning 35 ranges of 6 days (pancawara) in
  parallel.
...
- path: phase-1/docs/audit/AUTHORITY_VALIDATION_PACKET_wuku_epoch_2026-09-16.md
  role: audit
...
The 210-day cycle partitioning 35 ranges of 6 days (pancawara) in parallel.
