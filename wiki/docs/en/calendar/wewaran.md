---
canonical_term: wewaran
canonical_slug: wewaran
category: calendar
language_variants:
  ban:
...
- wewaran
short_definition: 10 parallel cycles (Eka..Dasa Wara), each emitting one value per
  day.
...
10 parallel cycles (Eka..Dasa Wara), each emitting one value per day.
