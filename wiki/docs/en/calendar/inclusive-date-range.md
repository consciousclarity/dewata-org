...
short_definition: Inclusive start..end range. end < start → HTTP 400. > 366 days →
  HTTP 413 (see RANGE_LIMIT).
...
Inclusive start..end range. end < start → HTTP 400. > 366 days → HTTP 413 (see RANGE_LIMIT).
