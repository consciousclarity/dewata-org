---
canonical_term: desa-adat-visibility
canonical_slug: desa-adat-visibility
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: desa-adat-visibility
  en:
    status: implementation_definition
    spelling: desa-adat-visibility
alternative_spellings:
- desa-adat-visibility
short_definition: visibility tier that shows records to the relevant desa adat.
