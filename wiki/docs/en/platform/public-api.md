---
canonical_term: public-api
canonical_slug: public-api
category: platform
language_variants:
  ban:
...
- public-api
short_definition: public interface of the engine at `api.dewata.org`. Currently DSP
  only.
