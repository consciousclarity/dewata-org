---
canonical_term: registered
canonical_slug: registered
category: platform
language_variants:
  ban:
...
- registered
short_definition: visibility level for a record registered by an actor.
...
- path: README_BAL.md
  role: policy
  quote: kacatet olih aktor / "registered"
