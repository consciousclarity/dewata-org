---
canonical_term: production-release
canonical_slug: production-release
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: production-release
  en:
    status: verified_source
    spelling: production-release
alternative_spellings:
- production-release
short_definition: fully-signed release that is publicly deployed; the repository has
  none yet.
