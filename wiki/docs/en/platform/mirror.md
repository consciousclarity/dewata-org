...
- mirror
short_definition: an independent copy of the repository, usually held by a banjar
  or desa adat, for censorship-resistant evidence.
...
- path: README_ID.md
  role: policy
  quote: mirror-redundancy at release time
