---
canonical_term: candidate-release
canonical_slug: candidate-release
category: platform
language_variants:
  ban:
  ...
  id:
    ...
    spelling: candidate-release
  en:
    status: verified_source
    spelling: candidate-release
alternative_spellings:
- candidate-release
short_definition: release pending customary sign-off and community review.
