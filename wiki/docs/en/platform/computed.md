---
canonical_term: computed
canonical_slug: computed
category: platform
language_variants:
  ban:
...
- computed
short_definition: visibility level for a record computed by the engine and not seen
  by a human.
...
- path: README_BAL.md
  role: policy
  quote: diproduksi olih mesin / "computed"
