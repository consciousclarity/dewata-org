---
canonical_term: tumpek-landep
canonical_slug: tumpek-landep
category: rahinan
language_variants:
  ban:
  ...
  id:
    ...
    spelling: tumpek-landep
  en:
    status: implementation_definition
    spelling: tumpek-landep
alternative_spellings:
- tumpek-landep
short_definition: engine rahinan id 'tumpek_landep' triggers when Saniscara + Keliwon
  (Tumpek Landep).
...
engine rahinan id 'tumpek_landep' triggers when Saniscara + Keliwon (Tumpek Landep).
