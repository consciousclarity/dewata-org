---
canonical_term: anggara-kliwon
canonical_slug: anggara-kliwon
category: rahinan
language_variants:
  ban:
  ...
  id:
    ...
    spelling: anggara-kliwon
  en:
    status: implementation_definition
    spelling: anggara-kliwon
alternative_spellings:
- anggara-kliwon
short_definition: engine rahinan id 'anggara_kliwon' triggers when Anggara + Keliwon
  (Anggara Kasih label).
...
engine rahinan id 'anggara_kliwon' triggers when Anggara + Keliwon (Anggara Kasih label).
