---
canonical_term: redite-paing
canonical_slug: redite-paing
category: rahinan
language_variants:
  ban:
  ...
  id:
    ...
    spelling: redite-paing
  en:
    status: implementation_definition
    spelling: redite-paing
alternative_spellings:
- redite-paing
short_definition: engine rahinan id 'redite_paing' triggers when Redite (Sunday) +
  Paing.
...
engine rahinan id 'redite_paing' triggers when Redite (Sunday) + Paing.
