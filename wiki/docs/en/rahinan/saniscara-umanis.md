---
canonical_term: saniscara-umanis
canonical_slug: saniscara-umanis
category: rahinan
language_variants:
  ban:
  ...
  id:
    ...
    spelling: saniscara-umanis
  en:
    status: implementation_definition
    spelling: saniscara-umanis
alternative_spellings:
- saniscara-umanis
short_definition: engine rahinan id 'saniscara_umanis' triggers when Saniscara + Umanis
  (Tumpek Kandang in some traditions).
...
engine rahinan id 'saniscara_umanis' triggers when Saniscara + Umanis (Tumpek Kandang in some traditions).
