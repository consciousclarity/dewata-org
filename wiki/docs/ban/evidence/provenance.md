...
# /ban stub untuk evidence/provenance
...
> Bahasa Indonesia ([/id/evidence/provenance](/id/evidence/provenance))
> dan Bahasa Inggris ([/en/evidence/provenance](/en/evidence/provenance))
