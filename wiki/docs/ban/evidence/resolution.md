...
# /ban stub untuk evidence/resolution
...
> Bahasa Indonesia ([/id/evidence/resolution](/id/evidence/resolution))
> dan Bahasa Inggris ([/en/evidence/resolution](/en/evidence/resolution))
