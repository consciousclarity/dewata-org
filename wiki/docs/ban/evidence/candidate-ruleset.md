...
# /ban stub untuk evidence/candidate-ruleset
...
> Bahasa Indonesia ([/id/evidence/candidate-ruleset](/id/evidence/candidate-ruleset))
> dan Bahasa Inggris ([/en/evidence/candidate-ruleset](/en/evidence/candidate-ruleset))
