...
# /ban stub untuk evidence/verification-status
...
> Bahasa Indonesia ([/id/evidence/verification-status](/id/evidence/verification-status))
> dan Bahasa Inggris ([/en/evidence/verification-status](/en/evidence/verification-status))
