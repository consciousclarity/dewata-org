...
# /ban stub untuk platform/signed-snapshot
...
> Bahasa Indonesia ([/id/platform/signed-snapshot](/id/platform/signed-snapshot))
> dan Bahasa Inggris ([/en/platform/signed-snapshot](/en/platform/signed-snapshot))
