...
# /ban stub untuk platform/api-endpoint
...
> Bahasa Indonesia ([/id/platform/api-endpoint](/id/platform/api-endpoint))
> dan Bahasa Inggris ([/en/platform/api-endpoint](/en/platform/api-endpoint))
