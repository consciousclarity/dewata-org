...
# /ban stub untuk platform/predicted
...
> Bahasa Indonesia ([/id/platform/predicted](/id/platform/predicted))
> dan Bahasa Inggris ([/en/platform/predicted](/en/platform/predicted))
