...
# /ban stub untuk platform/computed
...
> Bahasa Indonesia ([/id/platform/computed](/id/platform/computed))
> dan Bahasa Inggris ([/en/platform/computed](/en/platform/computed))
