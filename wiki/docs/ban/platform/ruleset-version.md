...
# /ban stub untuk platform/ruleset-version
...
> Bahasa Indonesia ([/id/platform/ruleset-version](/id/platform/ruleset-version))
> dan Bahasa Inggris ([/en/platform/ruleset-version](/en/platform/ruleset-version))
