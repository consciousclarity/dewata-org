...
# /ban stub untuk platform/candidate-release
...
> Bahasa Indonesia ([/id/platform/candidate-release](/id/platform/candidate-release))
> dan Bahasa Inggris ([/en/platform/candidate-release](/en/platform/candidate-release))
